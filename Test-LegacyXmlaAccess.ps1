...
.EXAMPLE
    .\Test-LegacyXmlaAccess.ps1 -Environment USGov -WorkspaceName 'DOH-PBIDashBoards' -DatasetName 'Tobacco Dashboard'
.EXAMPLE
    .\Test-LegacyXmlaAccess.ps1 -WorkspaceName 'DOH-PBIDashBoards' -DatasetName 'Tobacco Dashboard' -SkipAz -ForceLogin
#>
[CmdletBinding()]
param(
